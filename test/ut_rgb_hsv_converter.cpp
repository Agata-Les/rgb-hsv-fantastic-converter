...
namespace constant
{
	...
	const std::pair<RGB, HSV> dummy_colour = { {137, 16, 212}, {277.0, 92.5, 83.1} };
...
TEST_P(ut_rgb_hsv_converter, convert_HSV_to_RGB_correct_values)
{
	EXPECT_EQ(convert_HSV_to_RGB(GetParam().second), GetParam().first);
}
